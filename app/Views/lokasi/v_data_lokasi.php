...
<div class="card mb-4">
    <div class="card-header">
        ...
        DataTable Kemakmuran Masjid
        <a href="<?= base_url('lokasi/cetak/') ?>" class="btn btn-primary" target="_BLANK">PRINT</a>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    ...
                    <?php foreach ($lokasi as $key => $value) { ?>
                        <tr>
                            ...
                            <td><img src="<?= base_url('foto/' . $value['foto_lokasi']) ?>" width="150"></td>
                            <td>
                                <a href="<?= base_url('Lokasi/editLokasi/' . $value['id_lokasi']) ?>" class="btn btn-warning">Edit</a>
                                <a href="<?= base_url('Lokasi/deletelokasi/' . $value['id_lokasi']) ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')">Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
